...
SCENARIO
---------
75.The element is present but Selenium cannot click it. What will you do?
...
76. Your locator worked yesterday but not today. What will you do?
...
77. Your test fails with StaleElementReferenceException. How will you fix it?
I would locate the element again after the page refresh or DOM update instead of reusing the old WebElement reference.

78. Your click works locally but fails in Jenkins. Why?
...
79.A Selenium click fails with ElementClickInterceptedException. How do you diagnose and fix it?
...
80.Why shouldn't you immediately use JavaScript click?
...
81.A test fails with NoSuchElementException even though the element is visible manually. What do you check?
...
82.Can you simply catch the StaleElementReferenceException and retry?
...
83.A test times out waiting for a spinner to disappear, but the page looks complete. How do you debug it?
...
84.Why is waiting for the next page element often better than waiting for the spinner?
...
85.A test opens a payment window, but Selenium remains on the original page. How do you handle it robustly?
...
86.Why do you wait for the number of windows instead of switching immediately?
...
87.An iframe is reloaded during a test and subsequent element actions fail. What do you do?
...
88.Why can't you reuse the old WebElement after the iframe reloads?
...
89.What exception might occur if you try to use the old element after the iframe reloads?
...
90.Which ExpectedCondition would you use to handle this scenario?
...
91.A dropdown option is visible but Selenium Select throws UnexpectedTagNameException. Why, and how do you automate it?
...
92.A file-download test passes locally but fails on Selenium Grid. How do you fix it?
...
93.Why can't you verify the file in your local Downloads folder?
...
94.An automated login test fails only when run after another test. How do you identify the dependency?
...
95.How do you avoid dependencies between tests?
...
96.A test fails only at a smaller browser resolution. Is it an automation defect or a product defect?
...
97.How do you scroll to an element if it's outside the viewport?
I can use JavaScriptExecutor to scroll the element into view before performing the action.

98.How would you automate a page with data that loads continuously as the user scrolls?
...
99.How do you know when to stop scrolling?
...
100.A CAPTCHA appears in the automated test environment. What should you do?
...
101.A test occasionally clicks the wrong row action in a changing table. How would you fix it?
...
102.Why shouldn't you use row indexes?
...
103.A Selenium suite leaves many Chrome processes running after failures. How do you correct it?
...
104.The test clicks Save twice because the first response is slow. How would you prevent a duplicate record?
...
105.Would you use JavaScript click if the first click is slow?
...
106.The browser displays an SSL certificate warning in the test environment. What do you do?
...
107.Should you ignore SSL warnings in Production?
...
108.A test fails because a toast message disappears too quickly. How do you validate it reliably?
...
109.Why shouldn't you use Thread.sleep() for toast messages?
